...
class Stars(models.Model):
    ...
    content = models.TextField(
        blank=True, verbose_name="Article text"
    )  # Content of the star
    ...
    tags = models.ManyToManyField(
        "TagPost", blank=True, related_name="tags", verbose_name="Tags"
    )  # Tags associated with the star
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=["-time_create"]),]  # Index for faster querying by creation time
